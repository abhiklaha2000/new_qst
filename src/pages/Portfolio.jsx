  ...
  return (
    <Section className="pt-[9rem] -mt-[8.50rem]" crosses crossesOffset="lg:translate-y-[5.25rem]" customPaddings  >
      ...
      <div className="max-w-7xl mx-auto text-center">
        <h2 data-aos="flip-left" className="text-center text-4xl mb-4 text-blue-900 font-bold relative inline-block after:content-[''] after:block after:w-full after:h-1 after:bg-gradient-to-r after:from-red-500 after:to-transparent after:mt-2">Our Portfolio</h2>
